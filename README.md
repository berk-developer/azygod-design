...
<p align="center">
  <img src="https://github.com/berk-developer/azygod-design/releases/download/v2.0/hero-animation-v10-en.gif" alt="azygod-design Hero · Terminal → 4 yön → Galeri dalgalanması → 4 odaklanma → Marka ortaya çıkışı" width="100%">
</p>

<p align="center"><sub>
  ▲ 25 saniye · Terminal → 4 yön → Galeri dalgalanması → 4 odaklanma → Marka ortaya çıkışı<br>
  👉 <a href="#azygod-design-hero/">Ses efektleriyle HTML etkileşimli sürümü ziyaret et</a> ·
  <a href="https://github.com/berk-developer/azygod-design/releases/download/v2.0/hero-animation-v10-en.mp4">MP4 indir (BGM+SFX içerir · 10MB)</a>
</sub></p>
...
<p align="center"><img src="https://github.com/berk-developer/azygod-design/releases/download/v2.0/w3-fallback-advisor.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/berk-developer/azygod-design/releases/download/v2.0/c1-ios-prototype.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/berk-developer/azygod-design/releases/download/v2.0/c3-motion-design.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/berk-developer/azygod-design/releases/download/v2.0/c2-slides-pptx.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/berk-developer/azygod-design/releases/download/v2.0/c4-tweaks.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/berk-developer/azygod-design/releases/download/v2.0/c5-infographic.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/berk-developer/azygod-design/releases/download/v2.0/c6-expert-review.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/berk-developer/azygod-design/releases/download/v2.0/w2-junior-designer.gif" width="100%"></p>
...
<p align="center"><img src="https://github.com/berk-developer/azygod-design/releases/download/v2.0/w1-brand-protocol.gif" width="100%"></p>
...
**Kurumsal ticari kullanım yasaktır**—herhangi bir şirket, ekip veya kâr amacı güden organizasyon, bu skill'i ürününe entegre etmek, dış hizmet olarak sunmak veya müşteriye teslimatta kullanmak isterse, **önce berk-developer ile iletişime geçip yetki almalıdır**. Şunlar dahil ancak bunlarla sınırlı değildir:
...
## İletişim · berk-developer

berk-developer, AI Native Coder, bağımsız geliştirici ve AI içerik üreticisidir. Öne çıkan çalışmaları: Kitty Softbox (AppStore Ücretli Listesi #1), 《DeepSeek'le Baştan Sona》, Nuwa .skill (GitHub 12000+ star). Sosyal medyada toplam 300.000+ takipçisi vardır.

| Platform | Hesap | Bağlantı |
|---|---|---|
| X / Twitter | @berk-developer | https://x.com/berk-developer |
| WeChat Official | berk-developer | WeChat'te "berk-developer" ara |
...
Ticari kullanım yetkisi, iş birliği danışmanlığı, içerik siparişi → Yukarıdaki platformların herhangi birinden berk-developer'a özel mesaj atabilirsiniz.
